...
public class EsDbEventStore : IEventStore
{
    ...
    public EsDbEventStore(EventStoreClient client, string tenantPrefix)
    {
        _client = client;
    ...
    public async Task<IEnumerable<object>> LoadEvents(string stream, long? version = null)
    {
    ...
    public Task AppendSnapshot(string streamName, long aggregateVersion, object snapshot)
    {
